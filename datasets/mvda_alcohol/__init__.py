...
# data set paths
__data_set_path = "{}/data/alcohol.xlsx".format(os.path.split(__file__)[0])

__pickle_path = "{}/cache/mvda_alcohol.pickle".format(os.path.split(__file__)[0])
...
def load_mvda_alcohol():
    # loading the data set using pandas
    alcohol_ds = pd.read_excel(__data_set_path)
