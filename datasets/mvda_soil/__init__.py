...
# data set paths
__data_set_path = "{}/data/mvda-soil-isis.txt".format(os.path.split(__file__)[0])

__pickle_path = "{}/cache/mvda_soil.pickle".format(os.path.split(__file__)[0])

soil_type_regex = r'^([a-zA-Z]+)'
...
def load_mvda_soil():
    ...
    return utils.build_data_set(data, samples_labels, features_labels, extra_cols={'type': soil_types})
