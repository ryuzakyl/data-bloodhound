...
__pickle_path = "{}/cache/gc_wines.pickle".format(os.path.split(__file__)[0])
...
def load_gc_wines():
    ...
    return utils.build_data_set(gc_data, samples_labels, gc_labels, extra_cols={'origin': wine_origin})
